...
namespace TrustgraphCore.Services
{
    public class GraphQueryServicePointer 
    {
        ...
        protected void SearchIssuer(QueryContextPointer context, GraphIssuerPointer issuer)
        {
            ...
            {
                for (; tracker.SubjectIndex < issuer.Subjects.Length; tracker.SubjectIndex++)
                {
            ...
            {   // Otherwise continue down!
                for (var i = 0; i < issuer.Subjects.Length; i++)
                {
        ...
        protected void SearchSubject(QueryContextPointer context, GraphTracker tracker)
        {
            ...
            //if (subjects[i].SubjectType != context.Query.SubjectType ||
        ...
        //while (context.Queue.Count > 0 && context.Level < 4) // Do go more than 4 levels down
        //{
