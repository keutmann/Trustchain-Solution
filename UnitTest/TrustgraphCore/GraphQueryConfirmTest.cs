...
namespace UnitTest.TrustgraphCore
{
    ...
    public class GraphQueryConfirmTest : GraphQueryMock
    {
        ...
        public void Source1Target1()
        {
            ...
            _trustBuilder.AddTrust("C", "person", ClaimConfirmTrue);
            ...
            VerfifyResult(context, "C", "person", ClaimConfirmTrue);
        }
        ...
        //    var queryBuilder = new QueryRequestBuilder(ClaimTrustTrue.ToString());
