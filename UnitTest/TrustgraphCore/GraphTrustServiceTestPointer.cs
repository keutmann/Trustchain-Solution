...
{
    [TestClass]
    public class GraphTrustServiceTestPointer : StartupMock
    {
        ...
        public void NodeIndex()
        {
            ...
            var graphModelService = new GraphModelServicePointer();
        ...
        {
            var graphModelService = new GraphModelServicePointer();
            var graphTrustService = new GraphTrustServicePointer(graphModelService);
